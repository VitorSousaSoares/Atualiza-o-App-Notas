  ...
  return(
    ...
    <View style={styles.BOXDH}>
        ...
        >
            ...
            <Text style={styles.DataHoraTXT}>{props.Nota[props.Id].Conteudo[props.IdItem].Dia}</Text>
        </TouchableOpacity>
        ...
        >
            ...
            <Text style={styles.DataHoraTXT}>{props.Nota[props.Id].Conteudo[props.IdItem].Hora}</Text>
        </TouchableOpacity>
        {
            show && (
                <DateTimePicker
